...
\[
|f(H)| = {|H|\choose2} \quad \text{This could be useful to calculate }  |\mathbb{H}^n_k|\]
\[
...
\captionof{figure}{Heat map of how $H^{2026}$ changes over $f$, 5000 simulations}
...
M_t:=\max(H_t).
\]
A merge replaces $a,b\in H_t$ by $c=\lvert a-b\rvert$, so
\[
...
\captionof{figure}{Distribution of $F$ for $N = 4,5,6$}
\end{minipage}
\vspace{5pt}
